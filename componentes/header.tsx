...
>>>>>>> a80bd46 (dev 25.02.26)
          ...
          <div className="flex justify-end gap-5 col-span-8 md:col-span-2">
            <div className="hidden md:flex gap-2">
              <a
                className="flex items-center gap-2 text-white border-2 border-white px-4 py-2 uppercase font-medium text-sm rounded-full"
                href="https://wa.me/5592984728001"
                target="_blank"
                rel="noopener noreferrer"
              >
                <Image src="/whatsapp.svg" width={18} height={18} alt="" />
                Contato
              </a>
            </div>
