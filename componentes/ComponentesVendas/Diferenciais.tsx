...
const Diferenciais = () => {
  return (
    <section className="relative after:absolute after:content-[''] after:top-0 after:right-0 after:bg-[url(/vector-diferencias 2.svg)] after:h-10 after:w-10 after:bg-cover after:bg-no-repeat after:bg-center max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
